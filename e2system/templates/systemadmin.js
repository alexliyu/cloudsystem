            ...
            items : [{
                        ...
                        items : [{
                                    ...
                                    handler : function() {
                                        var me = this.up().up().up().up();
                                        me.items.items[1].removeAll();
                                        me.items.items[1].add(new appper)
...
Ext.define('E2system.systemadmin', {
    ...
    createWindow : function() {
        ...
        var win = desktop.getWindow('systemadminWindow');
        if (!win) {
            win = desktop.createWindow({
                        id : 'systemadminWindow',
                        title : '系统管理',
                        width : 740,
                        height : 480,
                        iconCls : 'icon-grid',
