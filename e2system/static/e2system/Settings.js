...
Ext.define('E2system.kernel.Settings', {
    ...
    uses: [
        ...
        'E2system.kernel.WallpaperModel'
    ],
    ...
    createTree : function() {
        ...
        var tree = new Ext.tree.Panel({
            ...
            store: new Ext.data.TreeStore({
                model: 'E2system.kernel.WallpaperModel',
                root: {
                    text:'Wallpaper',
                    expanded: true,
                    children:[
    ...
    onSelect: function (tree, record) {
        ...
        if (record.data.img) {
            me.selected = '/static/wallpapers/' + record.data.img;
        } else {
    ...
    setInitialSelection: function () {
        ...
        if (s) {
            var path = '/static/Wallpaper/' + this.getTextOfWallpaper(s);
