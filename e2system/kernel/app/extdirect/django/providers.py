...
""" % (self.namespace, descriptor, jsonDumpStripped(self._config))
    ...
    def router(self, request):
        ...
        #return HttpResponse("""{"type":"rpc","tid":1,"action":"auth_User","method":"read","result":[{"name":"ABC Accounting","turnover":50000},{"name":"Ezy Video Rental","turnover":106300},{"name":"Greens Fruit Grocery","turnover":120000},{"name":"Icecream Express","turnover":73000},{"name":"Ripped Gym","turnover":88400},{"name":"Smith Auto Mechanic","turnover":222980}]}""", mimetype=mimetype)
